...
class Cifar10Trainer(Executor):
    def __init__(
        ...
        dist_client1 = [2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000]
        client1_indices = []
        ...
        self._train_dataset,_=train_test_split(client1_dataset, train_size=0.8,test_size=0.2, random_state=42)
