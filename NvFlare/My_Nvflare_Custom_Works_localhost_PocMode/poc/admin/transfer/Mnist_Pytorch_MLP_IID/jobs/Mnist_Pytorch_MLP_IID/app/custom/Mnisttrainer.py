...
class MnistTrainer(Executor):
    def __init__(
        ...
        simple network on Mnist dataset. For submit_model task, it sends the locally trained model
        ...
        self._train_dataset,_ = trainset,validset=train_test_split(train_dataset, train_size=0.8,test_size=0.2, random_state=42)
        self._train_loader= DataLoader(self._train_dataset, batch_size=32,shuffle=True)
